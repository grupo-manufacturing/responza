...
/** Table-based layout + inline CSS for broad email client support. Brand: warm paper + accent blue (matches landing). */
...
/**
 * Vite/Connect middleware: same origin + port as the app (e.g. POST /api/waitlist).
